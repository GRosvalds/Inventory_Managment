...
import { Edit2, Trash2, Mail, Phone, User as UserIcon, MapPin, Building, Lock, Unlock } from 'lucide-react';
import UserAvatar from './UserAvatar';

const UserCard = ({ user, onEdit, onDelete, onToggleBlock, onToggleUnblock }) => {
